...
header-includes:
  ...
  - \usepackage{graphicx}
  - \usepackage{caption}
  - \captionsetup{justification=centering,font=it,labelfont=it,skip=2pt}
---

\begin{titlepage}
\centering
\vspace{2.8cm}
{\Huge EU Funding Compass\par}
\vspace{1.2cm}
...
\captionof{table}{Retrieval candidates compared.}
\vspace{0.8em}
...
\captionof{table}{Coefficient matrix tested for the hybrid confidence score.}
\vspace{0.8em}
...
\captionof{table}{Relevance grades used for retrieval evaluation.}
\vspace{0.8em}
...
\captionof{table}{Label distribution for the relevance fields used in the benchmark.}
\vspace{0.8em}
...
\captionof{table}{Top retrieval configurations on the 200 query benchmark.}
\vspace{0.8em}
...
\captionof{table}{High level notebook structure.}
\vspace{0.8em}
...
Author contribution statement: We all contributed equally to conceptualization,
methodology, data curation, software development, validation, formal analysis,
visualization, and writing through several in person pair programming sessions.
